...
def save_checkpoint(state, is_best,task_id, for_agg,  fpath="checkpoint.pth.tar",fpath_id = "checkpoint.pth.tar", cam_id=None):
    ...
    # else:
    # shutil.copy(fpath, osp.join(osp.dirname(fpath), str(task_id)+"_Cam_"+str(cam_id)+"_model_best.pth"))
    if for_agg:
        shutil.copy(fpath, osp.join(osp.dirname(fpath), "model_best_agg.pth"))
    else:
        shutil.copy(fpath, osp.join(osp.dirname(fpath), "Cam_"+str(cam_id)+"_model_best.pth"))
